...
export default function Experience({ content }: ExperienceProps) {
  return (
    <div className="group relative flex flex-row pl-8 md:h-56 md:pl-16">
      ...
      <div className="absolute top-0 left-0 h-1/2 w-8 rounded-bl-full border-l-2 border-b-2 border-slate-300 dark:border-slate-700 md:w-16" />
