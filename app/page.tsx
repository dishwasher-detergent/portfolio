...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      <div className="w-full md:h-[75vh] p-6 md:p-12 relative">
        <div className="w-full h-full flex flex-col justify-between md:justify-center items-center bg-gradient-to-br from-white/50 to-transparent rounded-[3rem] md:rounded-[6rem] text-white relative z-10">
          ...
          <div className="md:absolute md:bottom-0 w-full flex items-center justify-center h-24 md:h-32">
