...
export function Project({
  ...
  return (
    <div className="relative w-full md:h-60 flex flex-col md:flex-row md:items-center group cursor-pointer p-4">
      ...
      <div className="flex-1 overflow-hidden space-y-2 py-2 md:py-0 z-50">
