...
export function Marquee({ text }: MarqueeProps) {
  return (
    <section className="py-4">
      <div className="relative flex overflow-hidden select-none gap-4 md:text-6xl text-4xl font-black text-white py-4">
      ...
      <div className="relative flex overflow-hidden select-none gap-4 md:text-6xl text-4xl font-black text-white py-4 font-display">
